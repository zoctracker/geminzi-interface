...
export function AccessControl() {
  ...
  // Simulation de recrues (À connecter au Smart Contract plus tard)
  const recruitCount = 0;
  const maxRecruits = 5; // Rareté artificielle

  const generateCode = () => {
    if (!address) return;
    // Génère un pseudo-hash unique "GMNZ-XXXX"
  ...
  return (
    <div className="w-full mt-12 mb-20 font-mono">
      ...
      <div className="relative bg-gradient-to-b from-neutral-900 to-black border border-amber-500/30 rounded-xl p-1 shadow-[0_0_30px_rgba(245,158,11,0.05)]">
        ...
        {/* En-tête Doré */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black px-4 py-1 border border-amber-500/50 rounded-full">
        ...
        <div className="p-6 pt-8 text-center">
            ...
            {!code ? (
                <button 
                    ...
                    className="group relative inline-flex items-center justify-center px-8 py-3 overflow-hidden font-bold text-white transition-all duration-300 bg-amber-600 rounded hover:bg-amber-500 focus:outline-none focus:ring"
                >
                ...
                <div className="animate-fade-in-up">
                    ...
                    <div 
                        ...
                        className="cursor-pointer bg-amber-950/20 border border-amber-500/50 rounded-lg p-4 flex items-center justify-between hover:bg-amber-900/20 transition-colors group"
                    >
